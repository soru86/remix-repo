...
const json$2 = function json(data, init) {
  if (init === void 0) {
    init = {};
  }
...
const routes = {
  ...
  "routes/animations.$animationId": {
    id: "routes/animations.$animationId",
  ...
  "routes/animations.new": {
    id: "routes/animations.new",
    parentId: "routes/animations",
    path: "new",
    index: void 0,
    caseSensitive: void 0,
